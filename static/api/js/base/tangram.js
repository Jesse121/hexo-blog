window._bd_share_main.F.module("base/tangram", function (e, t) {
        ...
        function () {
            ...
            function (e) {
                ...
                getDocument: function () {
                    if (this.size() <= 1 9 0) return undefined; var e="this[0];" e.nodetype="=" ? : e.ownerdocument || e.document } }), t._util_.cleandata="function" (e) { n; for (var r="0," i; i="e[r];" r++) n="t.id(i," "get"); if (!n) continue; t._util_.eventbase.queue.remove(i), t.id(i, "remove") }, t.dom.extend({ empty: function () e++) n.nodetype="==" && t._util_.cleandata(n.getelementsbytagname("*")); while (n.firstchild) n.removechild(n.firstchild) this append: t.check("^(?:string|function|htmlelement|\\$dom)(?:,(?:string|array|htmlelement|\\$dom))*$", "baidu.dom.append"), t._util_.smartinsert(this, arguments, this.nodetype="==" this.appendchild(e) html: s="!1," o="!!r.support.dom.div.getElementsByTagName("link").length," u="r.support.dom.div.firstChild.nodeType" =="=" 3, a; (!this.size()) switch (typeof e) case "undefined": default: f="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video" , l="/<(?:script|style|link)/i," c="new" regexp("<(?:" + ")[\\s>]", "i"),
                        h = /^\s+/,
                        p = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
                        d = /<([\w:]+) , v="{" option: [1, "<select multiple="multiple">", ""],
                            legend: [1, "<fieldset>", "</fieldset>"],
                            thead: [1, "<table>", "</table>"],
                            tr: [2, "<table><tbody>", "</tbody></table>"],
                            td: [3, "<table><tbody><tr>", "</tr></tbody></table>"],
                ...
                if (n.length <= 0 1 || e.size() <="0)" return; if (t.type(n[0])="==" "function") { var i="n[0]," s; return t.foreach(e, function (e, o) s="t.dom(e)," n[0]="i.call(e," o, s.html()), t._util_.smartinsert(s, n, r) }) } o="e.getDocument()" document, u="o.createDocumentFragment()," a="e.length" - 1, f; for (var l="0," c; c="n[l];" l++) c.nodetype ? u.appendchild(c) : t.foreach(~"string|number".indexof(t.type(c)) t.dom.createelements(c, c, (e) u.appendchild(e) }); (!(f="u.firstChild))" t) r.call(e.nodename.tolowercase()="==" "table" && f.nodename.tolowercase()="==" "tr" e.tbodies[0] e.appendchild(e.ownerdocument.createelement("tbody")) e, t u.clonenode(!0) u) }, t.dom.extend({ after: () t.check("^(?:string|function|htmlelement|\\$dom)(?:,(?:string|array|htmlelement|\\$dom))*$", "baidu.dom.after"), t._util_.smartinsert(this, arguments, this.parentnode this.parentnode.insertbefore(e, this.nextsibling) }), this t.makearray="function" n) r="n" []; e (e.length="=" null ~"string|function|regexp".indexof(t.type(e)) [].push.call(r, e) t.merge(r, e), map: t.check("function", "baidu.dom.map"); n="[]," t.foreach(this, (t, s) n[r++]="e.call(t," s, t, this.pushstack(n) t._util_.isxml="function" e.ownerdocument 0).documentelement; t.nodename !="=" "html" !1 clone: u(e) e.getelementsbytagname e.getelementsbytagname("*") e.queryselectorall e.queryselectorall("*") [] a(e, n.clearattributes n.clearattributes(), n.mergeattributes n.mergeattributes(e); switch (n.nodename.tolowercase()) case "object": n.outerhtml="e.outerHTML;" break; "textarea": "input": ~"checked|radio".indexof(e.type) (e.checked (n.defaultchecked="n.checked" = e.checked), n.value e.value (n.value="e.value))," n.defaultvalue="e.defaultValue;" "option": n.selected="e.defaultSelected;" "script": n.text e.text (n.text="e.text)" n[t.key] n.removeattribute(t.key) f(e, i) (i.nodetype !t.id(e, "get")) in a; u++) n.add(i, a.orig, null, a.one) l(e, l, h; ((!o !s) (e.nodetype="==" e.nodetype="==" 11) !t._util_.isxml(e)) i), h="l.length;" p="0;" p++) c[p] a(l[p], c[p]) (n) i); (r) f(l[p], !i.addeventlistener i.attachevent i.fireevent (i.attachevent("onclick", i.clonenode(!0).fireevent("onclick")), this.map(function l(this, }() t._util_.contains="document.compareDocumentPosition" !!(e.comparedocumentposition(t) & 16) (e="==" !1; (e.contains t.contains) e.contains(t); while (t="t.parentNode)" !0; contains: !n !e t._util_.contains(n, t._util_.smartinsertto="function" r, u; (i (!o.parentnode o.parentnode.nodetype="==" 11)) "before", t.merge(e, u)); else f="s[a];" a++) t._util_.smartinsert(t.dom(f),> 0 ? e.clone(!0, !0) : e, r)
            }, t.dom.extend({
                appendTo: function (e) {
                    var n = [],
                        r = n.push;
                ...
                if (e.size() <= 0 1 0) return e; switch (t.type(n)) { case "string": if (r="==" undefined) i.call(e, e[0], n); e.each(function (o, u) u, n, t.type(r)="==" "function" ? r.call(u, o, n)) : r, s) }); break; "object": for (var o in n) t._util_.access(e, n[o], i, r) } e }, t._util_.nodename="function" (e, t) e.nodename && e.nodename.tolowercase()="==" t.tolowercase() t._util_.propfixer="{" tabindex: "tabindex", readonly: "readonly", "for": "htmlfor", "class": "classname", classname: maxlength: "maxlength", cellspacing: "cellspacing", cellpadding: "cellpadding", rowspan: "rowspan", colspan: "colspan", usemap: "usemap", frameborder: "frameborder", contenteditable: "contenteditable", rboolean: ^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$ i !document.createelement("form").enctype (t._util_.propfixer.enctype="encoding" ), t._util_.prop="function" () var n="/^a(?:rea|)$/i," r="document.createElement("select")," s="{" get: function (t) r.specified parseint(r.value, 10) e.test(t.nodename) || n.test(t.nodename) t.href undefined }; !i.selected (s.selected="{" (e) t="e.parentNode;" (t.selectedindex, t.parentnode t.parentnode.selectedindex), null }), = null, u; (!e ~"238".indexof(i)) return; (i !="=" !t._util_.isxml(e)) {}; o.set (u="o.set(e," r)) u e[n]="r" o.get }(), t._util_.support.getsetattribute="t._util_.support.dom.div.className" "t", t._util_.nodehook="function" (t._util_.support.getsetattribute) e.name="e.id" e.coords="!0," (t, (e[n] r.value "" r.specified) set: t, e.setattributenode(r)), + t._util_.removeattr="function" (i, (!s i.nodetype 1) a; f="0," l; l="o[f];" f++) l, a="e.rboolean.test(l)," !a t._util_.attr(i, ""), i.removeattribute(r u), (i[u]="!1)" t._util_.attr="function" " a", "class" n), i; !0 typeof i.nodevalue !1 n.tolowercase() !1) e.removeattr(t, else n; (t[i]="!0)," t.setattribute(n, n.tolowercase()) type: (n.test(t.nodename) t.parentnode) s; (!i "radio" e.nodename(t, "input")) t.setattribute("type", s), (t.value="o)," value: "button") u.get(t, t.value "button")) u.set(t, r); e.support.getsetattribute (t.foreach(["width", "height"], l[e]="{" (n="==" "") e.setattribute(t, "auto"), l.contenteditable="{" u.get, u.set(e, t.foreach(["href", "src", "width", 2); (l.style="{" e.style.csstext.tolowercase() e.style.csstext="n" (n, c="o" !e.isxml(n), h, p; (!n ~"238".indexof(o)) (s t.dom.fn[r]) t.dom(n)[r](i); r.tolowercase(), h="l[r]" (e.propfixer.rboolean.test(r) u)); null) e.removeattr(n, h.set (p="h.set(n," i)) p (n.setattribute(r, i) h.get p) t.dom.extend({ attr: t._util_.access(this, e, t._util_.attr(e, }) before: t.check("^(?:string|function|htmlelement|\\$dom)(?:,(?:string|array|htmlelement|\\$dom))*$", "baidu.dom.before"), t._util_.smartinsert(this, arguments, this.parentnode this.parentnode.insertbefore(e, this) this bind: this.on(e, undefined, t.dom.match="function" r(e) while (e="e.parentNode)" e.nodetype t.push(e); - 1;> -1; n--)
            ...
            function () {
                ...
                getWindow: function () {
                    ...
                    return this.size() <= 0 ? undefined : e.parentwindow || e.defaultview } }), t.dom.extend({ offsetparent: function () { return this.map(function var e="this.offsetParent" document.body, n="/^(?:body|html)$/i;" while (e && t.dom(e).getcurrentstyle("position")="==" "static" !n.test(e.nodename)) }) position: if (this.size() <="0)" 0; t="this.offset()," r="e.test(n[0].nodeName)" left: 0, top: n.offset(); t.left -="parseFloat(this.getCurrentStyle("marginLeft"))" t.top r.left +="parseFloat(n.getCurrentStyle("borderLeftWidth"))" r.top r.left, offset: e(e, n, r) i="i" = t.dom(e), s="i.getCurrentStyle("position");" (e.style.position="relative" ); o="i.offset()," u="i.getCurrentStyle("left")," a="i.getCurrentStyle("top")," f="~"absolute|fixed".indexOf(s)" ~("" a).indexof("auto"), l="f" i.position(); l.left parsefloat(u) l.top parsefloat(a) t.type("options")="==" "function" (n="n.call(e," r, o)), n.left !="undefined" (e.style.left="n.left" o.left "px"), n.top (e.style.top="n.top" o.top "px") (n) t.check("^(?:object|function)$", "baidu.dom.offset"); for (var i; r++) e(i, r); this }, a, f; (!o) return; t._util_.contains(f, s) (typeof s.getboundingclientrect (u="s.getBoundingClientRect())," u.left (a.pagexoffset f.scrollleft) (f.clientleft 0), u.top (a.pageyoffset f.scrolltop) (f.clienttop 0) }() has: (e) t.foreach(this, (t) r[0]="t," r.find(e).length n.push(t) t.dom(n) hasclass: (arguments.length typeof "function") this; !1; "").replace( \s+$ g, \s+ " "); "), r; n.length; i++) (!~(" ").indexof(" n[i] ")) (r !1) t._util_.getwindowordocumentwidthorheight="t._util_.getWindowOrDocumentWidthOrHeight" window: {}, document: {} }; t.foreach(["width", "height"], n; e.window["get" n]="function" t.browser.isstrict n.body n.body[r] e.document["get" t[r]>= t[s] ? t[r] : Math.max(e.body[s], t[s], e.body[i], t[i])
                        }
                    }),
                    function (t, n, r) {
                ...
                innerHeight: function () {
                    if (this.size() <= 9 0) return 0; var e="this[0]," n="e" !="null" && e.window ? "window" : e.nodetype="==" "document" !1; t._util_.getwindowordocumentwidthorheight(e, n, "height") t._util_.getwidthorheight(e, "height", "padding") } }), t.dom.extend({ innerwidth: function () { if (this.size() <="0)" "width") "width", insertafter: (e) r="n.push;" t.check("^(?:string|htmlelement|\\$dom)$", "baidu.dom.insertafter"), t._util_.smartinsertto(this, e, r.apply(n, t.makearray(e.childnodes)), this.parentnode.insertbefore(e, this.nextsibling) }, "after"), this.pushstack(n) insertbefore: "baidu.dom.insertbefore"), this) "before"), inserthtml: (e, n) r, i, s="this[0];" s.insertadjacenthtml !t.browser.opera s.insertadjacenthtml(e, (r="s.ownerDocument.createRange()," "afterbegin" || "beforeend" (r.selectnodecontents(s), r.collapse(e="=" "afterbegin")) (i="e" =="BEFOREBEGIN" , r[i "setstartbefore" "setendafter"](s), r.collapse(i)), r.insertnode(r.createcontextualfragment(n))), is: t.dom.match(this, e).length> 0
                }
            }), t.dom.extend({
                last: function () {
                    return this.eq(-1)
                ...
                outerHeight: function (e) {
                    if (this.size() <= 1 9 0) return 0; var n="this[0]," r="n" !="null" && n.window ? "window" : n.nodetype="==" "document" !1; t._util_.getwindowordocumentwidthorheight(n, r, "height") t._util_.getwidthorheight(n, "height", "padding|border" + (e "|margin" "")) } }), t.dom.extend({ outerwidth: function (e) { if (this.size() <="0)" "width") "width", parent: t.foreach(this, e.nodetype="=" n.push(e) this.pushstack(t.dom.match(n, e)) parents: while ((e="e.parentNode)" 1) r.push(e); t.merge(n, r) parentsuntil: (e, n) t.check("(string|htmlelement)(,.+)?", "baidu.dom.parentsuntil"); (n) i="t.array();" ((n="n.parentNode)" i.push(n); i.length) s="t.dom.match(i," e); s.length (i="i.slice(0," i.indexof(s[0]))) t.merge(r, i) this.pushstack(t.dom.match(r, n)) prepend: () t.check("^(?:string|function|htmlelement|\\$dom)(?:,(?:string|array|htmlelement|\\$dom))*$", "baidu.dom.prepend"), t._util_.smartinsert(this, arguments, this.nodetype="==" this.insertbefore(e, this.firstchild) this prependto: t.check("^(?:string|htmlelement|\\$dom)$", "baidu.dom.prependto"), t._util_.smartinsertto(this, e, r.apply(n, t.makearray(e.childnodes)), this.pushstack(n) prev: (e.nodetype="=" n.push(e); break prevall: r.reverse()) this.pushstack(typeof e="=" "string" t.dom.match(n, e) n.unique()) prevuntil: "baidu.dom.prevuntil"); (n="n.previousSibling)" prop: t._util_.access(this, n, t._util_.prop(e, }) t.string.extend({ escapereg: this.replace(new regexp("([.*+?^="!:${}()|[\\]/\\\\])"," "g"), "\\$1") void w(e, t, i, u, a, f, l="o++," c="0," h="t.length;" typeof !d.test(n) f="n);" for (; h; c++) (i) u="!1," (i[s]="==" l) a="i.nodeType" =="=" 1, !r i.sizset="c);" (f) (i.nodename.tolowercase()="==" else (a) (typeof ) (f(n, [i]).length> 0) {
                                u = i;
                                break
                            }
                            i = i[e]
            ...
            scrollLeft: function () {
                ...
                return function (n) {
                    return n && t.check("^(?:number|string)$", "baidu.dom.scrollLeft"), this.size() <= 0 ? n="==" undefined : this e.get(this[0]) e.set(this[0], n) || } }() }), t.dom.extend({ scrolltop: function () { var e="t._util_.smartScroll("scrollTop");" return (n) && t.check("^(?:number|string)$", "baidu.dom.scrolltop"), this.size() <="0" t.dom.setpixel="function" (e, n, r) typeof r !="undefined" (t.dom.g(e).style[n]="r" + (isnan(r) "" "px")) }, t._util_.getdefaultdisplayvalue="function" if (e[n]) e[n]; i, s, o; document.body.appendchild(r), i="t.dom(r).getCurrentStyle("display")," document.body.removechild(r); (i="==" "none") s="document.body.appendChild(document.createElement("iframe"))," s.frameborder="s.width" = s.height="0," o="(s.contentWindow" s.contentdocument).document, o.writeln("<!doctype html><html><body>"), o.close(), r = o.appendChild(o.createElement(n)), i = t.dom(r).getCurrentStyle("display"), document.body.removeChild(s), s = null;
                return r = null, e[n] = i
            }
        }(), t.dom.extend({
            show: function () {
            ...
            text: function (e) {
                var n = t.dom,
                    ...
                    i = !1,
                    s;
                if (this.size() <= 0 1 2 3 9 0) switch (typeof e) { case "undefined": return undefined; default: r } var o="function" (e) t, n , i="e.nodeType;" if (i) (i="==" || 11) e.textcontent="=" "string") e.textcontent; for (e="e.firstChild;" e; e="e.nextSibling)" +="o(e)" else 4) e.nodevalue; }; t.foreach(r, function (t, r) u="n(t);" (s) return; s="o(t)," s; "number": "string": u.empty().append((t && t.ownerdocument document).createtextnode(e)); break; "function": u.text(e.call(t, r, u.text())) }), ? : t.dom.extend({ toggle: () (var t="this.size();" < t; e++) n.css("display") !="none" n.hide() n.show() toggleclass: (e, n) e, "undefined" boolean(n); arguments.length t.foreach(this, e.classname }); "").replace( \s+$ g, \s+ " "); i.length; r++) ~(" ").indexof(" i[r] ") typeof ").replace(" ", !~(" !0 !1 (t="t.replace(i[r]," "")); "") (r, i) t.dom(r).toggleclass(e.call(r, i, r.classname), }) this void (e.mousewheel) t.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, (n, e[n]="{" bindtype: pack: (t) t.type="n;" (!i !r(this, i)) e.apply(this, arguments) focusin: "focus", focusout: "blur" e[t]="{" n, attachelements: "textarea,select,input,button,a" e.mousewheel="{" "dommousescroll" "mousewheel", t.wheeldelta="t.wheelDelta" (n r.detail * -40 r.wheeldelta) 0, }(t.event.special), triggerhandler: !i.triggerdata (i.triggerdata="r)," n.call(t, undefined, }(t._util_.eventbase), a="{" submit: 3, focus: 2, blur: f="function" t) n; document.createevent n.initevent(e, !0, !0)) document.createeventobject n.type="e);" in try n[i]="t[i]" catch n.extradata (n.extradata="r)," r[i]="t[i]" l="function" (e.dispatchevent) e.dispatchevent(n); (e.fireevent) e.fireevent("on" c="function" o) u, c; (u="f(t," r)) (u.triggerdata="n);" (o) i.call(e, null, u); h="e.window" =="=" window a[t]; (h & !(t a)) u) (p) s(e).triggerhandler(t, (c 2) e[t]() {} trigger: i; this.each(function c(this, }(t._util_.eventbase, t.event), unbind: this.off(e, undelegate: this.off(t, unique: t.dom(t.array(this.toarray()).unique(e)) t._util_.inarray="function" (!t) -1; (r) r.call(t, n); math.max(0, 0; (; n++) t[n]="==" -1 val: t._util_.support.dom.select.disabled="!0;" "on", "checkbox"], option: get: !t t.specified e.value e.text select: (n) "select-one" null [], i.length, l, a; f++) ((l.selected s) (r !l.disabled l.getattribute("disabled")="==" null) (!l.parentnode.disabled !e.nodename(l.parentnode, "optgroup"))) u.push(c) set: t.dom(n).find("option").each(function r.selected="e.inArray(t.dom(this).val(),">= 0
        ...
        function () {
            ...
            t.dom.extend(n)
                ...
                subByte: function (e, n) {
                    ...
                    if (e < 0 || this.getByteLength() <= e) return this.valueof(); var r="this.substr(0," e).replace( ([^\x00-\xff]) g, "$1 ").substr(0, [^\x00-\xff]$ , "").replace( "$1"); + (n || "") } }), t.string.extend({ tohalfwidth: function () { this.replace( [\uff01-\uff5e] (e) string.fromcharcode(e.charcodeat(0) - 65248) }).replace( \u3000 " ") wbr: (?:<[^>]+>)|(?:&#?[0-9a-z]{2,6};)|(.{1})/gi, "$&<wbr>").replace(/><wbr>/g, ">")
                }
                ...
                var v = ["<object "]; for (o="0," a="p.length;" o < a; o++) f="p[o]," v.push(" ", f, '="', c(e[f]), '" ');>");
                var m = {
                    wmode: 1,
                    scale: 1,
                    quality: 1,
                ...
                e.src = e.movie, e.name = e.id, delete e.id, delete e.movie, delete e.classid, delete e.codebase, e.type = "application/x-shockwave-flash", e.pluginspage = "http://www.macromedia.com/go/getflashplayer", v.push("<embed"); var g; for (u in e) { f="e[u];" if (f || !1 0) ((new regexp("^salign$", "i")).test(u)) g="f;" continue } v.push(" ", u, '="', c(f), '" ') return && v.push(' salign="', c(g), '" '),></embed");></object>"), v.join("")
    ...
    t.T = r
});</=></[^></").replace(></=></body></html></=></a></=></=></=></=></=></$1></([\w:]+)></(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^></=></(\w+)></\></(\w+)\s*\></">